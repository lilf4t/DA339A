        ...
        switch (button) {
            case Add:
                ...
                */
                ...
                Object item = view.getCountriesItem(); //get the item chosen in the drop-down list of countries,
                // the program handles this as just an Object-object
                Countries country = (Countries) item; //make it a Countries object - we know that this is supposed to
                ...
                //ska ge ett meddelande ifall man vill lägga till mer gäster än det man angett
                if(register.getNbrOfGuests() < totalGuests ) {
                    register.addPerson(view.getFirstNameText(), view.getLastNameText(), view.getStreetText(),
                            view.getCityText(),  view.getZipCodeText(),  country);
                } else {
                    int a = JOptionPane.showConfirmDialog
                            (null, "The guest list is full, would you like to add 10 more?");
            ...
            case Change:
                ...
                if (validateIndex(index)) { //validateIndex is a private method in this class
                    ...
                    // denna tar emot index som man väljer man vill ändra
                    ...
                    if (guestToChange != null){
                        ...
                        //samma som finns där uppe, men vil vill få tillgång till adress, då använder vi guestToChange
                        Address addressToChange = guestToChange.getAddress();
                        //kolla case add: kolla mainframe,
                        Object item1 = view.getCountriesItem();
                        Countries country1 = (Countries) item1;
                        ...
                        addressToChange.setCountry(country1);
            ...
            case Delete:
                ...
                if (validateIndex(index)) {
                    ...
                    */
                    register.deleteElementAt(index);
                }
                break;
        }
    ...
    private void updateView(int index) {
        ...
        if(validateIndex(index)) {
           ...
           */
                ...
                view.setStreetText(register.getGuestAt(index).getAddress().getStreet());
                view.setCityText(register.getGuestAt(index).getAddress().getCity());
                view.setZipCodeText(register.getGuestAt(index).getAddress().getZipCode());
                view.setCountriesItem(register.getGuestAt(index).getAddress().getCountry());
            }
        }
    }
